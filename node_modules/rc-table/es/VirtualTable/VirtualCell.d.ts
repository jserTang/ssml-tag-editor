...
export interface VirtualCellProps<RecordType extends {
    index: number;
}> {
...
declare function VirtualCell<RecordType extends {
    index: number;
} = any>(props: VirtualCellProps<RecordType>): React.JSX.Element;
